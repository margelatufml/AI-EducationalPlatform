...
import OtterCloseMouthLoading from "../ui/otter_animations/otter_circle_close_mouth_Loading";
// import UserStatus from "../../pages/QuestionPage/UserStatus";
...
const MathInput = () => {
  ...
  useEffect(() => {
    ...
    document.onkeyup = (e) => {
      const key = e.code;
      if (!key) return; // Add this line to check if key exists
  ...
  useEffect(() => {
    const targetNode = document.querySelector("#MathJax_Message");
      ...
      for (let mutation of mutationsList) {
        if (
          ...
          if (displayStyle === "none") {
            setIsLoading(false); // Hide the loading screen when MathJax is done
  ...
  return (
    ...
    >
      ...
      ></div>
      <div id="viewModeLatex" style={{ display: "none" }}></div>
      {/* <UserStatus /> */}
        ...
        <ul className="flex flex-col items-end justify-items-end space-y-4 w-full h-full ">
          <li className="w-full pl-10">
            <div className="collapse bg-base-200 rounded-lg shadow-md shadow-blue-mainpagebeforeLogin hover:bg-gunmetal-airforce ">
              ...
              <div className="collapse-title text-xl font-medium">
                Simboluri de operații matematice:
              </div>
          ...
          <li className="w-full pl-10">
            <div className="collapse bg-base-200 rounded-lg shadow-md shadow-blue-mainpagebeforeLogin hover:bg-gunmetal-airforce">
              <input type="checkbox" />
              <div className="collapse-title text-xl font-medium">
                Simboluri de puteri și rădăcini:
              </div>
              <ul className="collapse-content flex flex-wrap space-x-2">
          ...
          <li className="w-full pl-10">
            <div className="collapse bg-base-200 rounded-lg shadow-md shadow-blue-mainpagebeforeLogin hover:bg-gunmetal-airforce">
              <input type="checkbox" />
              <div className="collapse-title text-xl font-medium">
                Simboluri pentru integrale și derivate:
              </div>
              <ul className="collapse-content flex flex-wrap space-x-2">
          ...
          <li className="w-full pl-10">
            <div className="collapse bg-base-200 rounded-lg shadow-md shadow-blue-mainpagebeforeLogin hover:bg-gunmetal-airforce">
              <input type="checkbox" />
              <div className="collapse-title text-xl font-medium">
                Simboluri pentru seturi și logica matematică:
              </div>
              <ul className="collapse-content flex flex-wrap space-x-2">
                {[
                  "not",
...
export const getElementContent = () => {
  const element = document.getElementById("viewModeLatex");
